      ...
      <article className="py-10">
        <header className="border-b border-gray-200 pb-8 dark:border-gray-700">
          <div className="mb-4 flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
            <Link href="/" className="font-medium transition-colors hover:text-gray-900 dark:hover:text-gray-100">
              Home
            </Link>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-3 w-3" aria-hidden>
              <path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6-6-6z" />
            </svg>
            <Link href="/blog" className="font-medium transition-colors hover:text-gray-900 dark:hover:text-gray-100">
              Blog
            </Link>
          </div>
